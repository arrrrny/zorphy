...
class C extends $C implements B, A {
  ...
  C({required this.a, required this.a});

  C._copyWith({Manager? a, Manager? a})
    : a =
          a ??
          (() {
            throw ArgumentError("a is required");
  ...
  C copyWith({Manager? a, Manager? a}) {
    return C(a: a ?? this.a, a: a ?? this.a);
  }

  C copyWithC({Manager? a, Manager? a}) {
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is C && a == other.a && a == other.a;
  }

  @override
  int get hashCode {
    return Object.hash(this.a, this.a);
  }
