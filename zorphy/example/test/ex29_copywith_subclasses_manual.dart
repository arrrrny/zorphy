...
class B<T1> implements A {
  ...
  B copyWith_B({Opt<String>? a, Opt<T1>? b}) {
    return B(
      a: a == null ? this.a as String : a.value as String,
...
class C<T1> implements B<T1> {
  ...
  C copyWith_B({Opt<String>? a, Opt<T1>? b}) {
    return C(
      a: a == null ? this.a as String : a.value as String,
      b: b == null ? this.b as T1 : b.value as T1,
      c: (this as C).c,
  ...
  C copyWith_C({Opt<String>? a, Opt<T1>? b, Opt<bool>? c}) {
    return C(
      a: a == null ? this.a as String : a.value as String,
      b: b == null ? this.b as T1 : b.value as T1,
...
class D<T1> implements B<T1> {
  ...
  D copyWith_B({Opt<String>? a, Opt<T1>? b}) {
    return D(
      a: a == null ? this.a as String : a.value as String,
      b: b == null ? this.b as T1 : b.value as T1,
    );
  ...
  D copyWith_D({Opt<String>? a, Opt<T1>? b}) {
    return D(
      a: a == null ? this.a as String : a.value as String,
      b: b == null ? this.b as T1 : b.value as T1,
    );
...
class Y implements X {
  ...
  Y copyWith_X() {
    return Y(a: (this as Y).a);
  }

  Y copyWith_Y({Opt<String>? a}) {
    return Y(a: a == null ? this.a as String : a.value as String);
  }
}
