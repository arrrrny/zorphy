...
part 'readme_test.zorphy.dart';

@Zorphy(generateJson: true, generateCopyWithFn: true, explicitSubTypes: [$Cat])
abstract class $Pet {
  String get name;
...
@Zorphy(generateJson: true, generateCopyWithFn: true)
...
@Zorphy(generateJson: true, explicitSubTypes: [$Z, $Y])
abstract class $X {
  String get val;
}

@Zorphy(generateJson: true, explicitSubTypes: [$Z])
