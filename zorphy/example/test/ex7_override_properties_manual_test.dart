...
class A extends $A {
  ...
  A copyWith_A({Opt<Person>? a}) {
    return A(a: a == null ? this.a as Person : a.value as Person);
  }
}
...
class B extends $B implements A {
  ...
  B copyWith_A({Opt<Person>? a}) {
    return B(a: a == null ? this.a as Employee : a.value as Employee);
  }

  B copyWith_B({Opt<Employee>? a}) {
    return B(a: a == null ? this.a as Employee : a.value as Employee);
  }
}
...
class C extends $C implements B {
  ...
  C copyWith_A({Opt<Person>? a}) {
    return C(a: a == null ? this.a as Manager : a.value as Manager);
  }

  C copyWith_B({Opt<Employee>? a}) {
    return C(a: a == null ? this.a as Manager : a.value as Manager);
  }

  C copyWith_C({Opt<Manager>? a}) {
    return C(a: a == null ? this.a as Manager : a.value as Manager);
  }
}
