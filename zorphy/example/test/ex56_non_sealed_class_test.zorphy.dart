...
class Todo2_complete_assigned implements $$Todo2 {
  ...
  Todo2_complete_assigned patchWithTodo2_complete_assigned({
    ...
    final _patchMap = _patcher.toPatch();
    return Todo2_complete_assigned(
        completedDate: _patchMap
                .containsKey(Todo2_complete_assigned$.completedDate)
  ...
  @override
  int get hashCode {
    return Object.hash(this.completedDate, this.title, this.id,
        this.description, this.managerId);
  }
  ...
  static Todo2_complete_assignedPatch create([Map<String, dynamic>? diff]) {
    ...
    if (diff != null) {
      diff.forEach((key, value) {
        try {
          final enumValue =
              Todo2_complete_assigned$.values.firstWhere((e) => e.name == key);
          if (value is Function) {
            patch._patch[enumValue] = value();
          } else {
            patch._patch[enumValue] = value;
