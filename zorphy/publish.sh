...
# Publish script for zorphy - updates version, CHANGELOG, commits, and publishes to pub.dev
...
echo "🚀 Publishing zorphy version $VERSION..."
echo ""
...
echo ""
echo "View on pub.dev: https://pub.dev/packages/zorphy/$VERSION"
