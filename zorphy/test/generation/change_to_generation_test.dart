...
void main() {
  group('changeTo extension generation', () {
    test(
      'requires field in changeTo if it is non-nullable in target but nullable in source',
      () {
    ...
    test(
      'retains field in changeTo if it is non-nullable in both source and target (optional override)',
      () {
        final sourceFields = <NameTypeClassComment>[
          NameTypeClassComment('id', 'String', 'Listing'),
        ];
